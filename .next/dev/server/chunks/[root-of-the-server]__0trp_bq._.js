...
async function PUT(request, { params }) {
    try {
        ...
        const existingTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].task.findFirst({
            where: {
                id,
                userId: user.id
            }
        ...
        // Update task
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].task.update({
            where: {
                id
            },
            data: updateData,
        ...
        if (status === 'done' && existingTask.status !== 'done') {
            const { generateCompletionMessage } = await __turbopack_context__.A("[project]/src/lib/nova.ts [app-route] (ecmascript, async loader)");
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        // Find task
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].task.findFirst({
            where: {
                id,
                userId: user.id,
                deletedAt: null
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0trp_bq._.js.map