...
"[project]/src/app/api/tasks/bulk/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (action === 'markAllDone') {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].task.updateMany({
                where: whereClause,
                data: {
                    status: 'done'
                }
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `${result.count} tugas berhasil ditandai selesai`,
                count: result.count
            }, {
                status: 200
            });
        ...
        if (action === 'deleteCompleted') {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `${result.count} tugas berhasil dihapus`,
                count: result.count
            }, {
                status: 200
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ggbdbv._.js.map