...
async function PUT(request, { params }) {
    try {
        ...
        // Find notification
        const notification = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].notification.findFirst({
            where: {
                id,
                userId: user.id
            }
        ...
        // Mark as read
        const updatedNotification = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].notification.update({
            where: {
                id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0suchd~._.js.map